...
export default function TenantCard(props: StatusCardProps) {
  ...
  return (
    <div
      className={`flex flex-col items-center justify-between w-96 h-58 p-4 space-y-4 text-white transition-all duration-500 rounded-lg shadow-xl bg-[#302F2F] hover:scale-110 hover:shadow-2xl relative
          ${
            offlineChargepoints > 0
              ? "before:w-6 before:h-6 before:bg-dashred before:absolute before:-right-2 before:-top-2 before:rounded-full"
              : ""
          }`}
    >
