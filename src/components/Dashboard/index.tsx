...
export default function Dashboard(props: DashboardProps) {
  ...
  return (
    <main className="flex flex-col justify-between gap-14">
      <Link
        href="/"
        className="absolute left-14 top-16 flex flex-row items-center gap-2 hover:bg-neutral-700 px-4 py-2 rounded-md transition duration-300 "
      >
              ...
              chargepoint.connectors.map((connector) => {
                switch (connector.lastStatus.status) {
                  ...
                  case "SuspendedEV":
                    return (
                      <div
                        key={chargepoint.chargeBoxPk}
                        className="bg-dashgreen w-28 h-28 md:w-40 md:h-40 lg:w-52 lg:h-52 flex flex-col justify-center items-center text-center rounded-xl"
                      >
                  ...
                  case "Faulted":
                    return (
                      <div
                        key={chargepoint.chargeBoxPk}
                        className="bg-dashred w-28 h-28 md:w-40 md:h-40 lg:w-52 lg:h-52 flex flex-col justify-center items-center text-center rounded-xl animate-pulse-alert"
                      >
                  ...
                  case "SuspendedEVSE":
                    return (
                      <div
                        key={chargepoint.chargeBoxPk}
                        className="bg-dashyellow w-28 h-28 md:w-40 md:h-40 lg:w-52 lg:h-52 flex flex-col justify-center items-center text-center rounded-xl"
                      >
                  ...
                  case "Maintenance":
                    return (
                      <div
                        key={chargepoint.chargeBoxPk}
                        className="bg-dashgray w-28 h-28 md:w-40 md:h-40 lg:w-52 lg:h-52 flex flex-col justify-center items-center text-center rounded-xl"
                      >
