...
import homeCard from "./../Cards/index";
import HomeCard from "./../Cards/index";
                ...
                switch (connector.lastStatus.status) {
                  ...
                  case "SuspendedEV":
                    return (
                      <div
                        ...
                        className="bg-[#2e8024] w-28 h-28 md:w-40 md:h-40 flex flex-col justify-center items-center text-center rounded-xl"
                      >
                  ...
                  case "Faulted":
                    return (
                      <div
                        key={chargepoint.chargeBoxPk}
                        className="bg-[#ed1c00] w-28 h-28 md:w-40 md:h-40 flex flex-col justify-center items-center text-center rounded-xl animate-pulse-alert"
                      >
                  ...
                  case "SuspendedEVSE":
                    return (
                      <div
                        key={chargepoint.chargeBoxPk}
                        className="bg-[#e4c306] w-28 h-28 md:w-40 md:h-40 flex flex-col justify-center items-center text-center rounded-xl"
                      >
                  ...
                  case "Maintenance":
                    return (
                      <div
                        key={chargepoint.chargeBoxPk}
                        className="bg-[#525252] w-28 h-28 md:w-40 md:h-40 flex flex-col justify-center items-center text-center rounded-xl"
                      >
